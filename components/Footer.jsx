    ...
    <footer className="bg-brand-dark text-slate-200 pt-16 pb-8 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 mb-8">
              ...
              <li className="flex items-start gap-2 text-slate-300 hover:text-brand-gold transition-colors">
                <span className="text-brand-gold">📱</span> 
                <a href="https://instagram.com/algoritmikizmirr" target="_blank" rel="noopener noreferrer">@algoritmikizmirr</a>
              </li>
            </ul>
            <div className="flex space-x-4">
              <a href="https://instagram.com/algoritmikizmirr" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-brand-gold hover:text-brand-dark hover:border-brand-gold transition-all hover:-translate-y-1">
        ...
        <div className="border-t border-white/10 pt-8 text-center text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} Algoritmik. Tüm hakları saklıdır. Çocuğunuzun geleceği benimle güvende.</p>
        </div>
      </div>
    </footer>
  );
